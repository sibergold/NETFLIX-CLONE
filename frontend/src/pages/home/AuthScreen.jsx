        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Watch on Smarts TVs, Playstation, Xbox, Chromecast, Apple TV,
          ...
          <div className="flex-1 relative">
            ...
            >
              <source
                src="/frontend_public_hero-vid.m4v"
                type="video/mp4"
              />
            </video>
          </div>
...
<img src='/public/stranger-things-lg.png' alt='Stranger Things img' className='mt-4'/>
       ...
       <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            >
              <source
                src="/frontend_public_video-devices.m4v"
                type="video/mp4"
              />
            </video>
          </div>
...
{/* right */}
<div className='flex-1 text-center md:text-left'>
<h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Create profiles for kid</h2>
<p className='text-lg md:text-xl'>
