...
const SearchPage = () => {
  ...
  return  <div className="bg-black min-h-screen text-white">
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <button className={`py-2 px-4 rounded ${activeTab === "movie" ? "bg-red-600" : "bg-gray-800"} hover:bg-red-700`} onClick={()=> handleTableClick("movie")} >
       Movies
      </button>
      <button className={`py-2 px-4 rounded ${activeTab === "movie" ? "bg-red-600" : "bg-gray-800"} hover:bg-red-700`} onClick={()=> handleTableClick("tv")} >
       TV Shows
      </button>
      <button className={`py-2 px-4 rounded ${activeTab === "movie" ? "bg-red-600" : "bg-gray-800"} hover:bg-red-700`} onClick={()=> handleTableClick("person")}>
       Person
      </button>
      </div>
        ...
        return (
            <div key={result.id} className="bg-gray-800 p-4 rounded">
            {
                activeTab === "person" ? (
                    ...
                    <img src={ORIGINAL_IMG_BASE_URL + result.profile_path} alt={result.title || result.name} className="w-full h-auto rounded"/>
